...
public class LinkedList<T> {
    ...
    public void removeRepeats() {
        for(int i = size() -1; i > 0; i--){
            //if elem at index i is == elem at index i + 1, remove elem at i
    ...
    public void reverse() {
        ...
        while (q != null){
            r = q.getNext();
            q.setNext(p); //set node after as the one before
    ...
    public void merge(LinkedList list2) {
        ...
        if (list1.size() >= list2.size()) {
            for (int i = 0; i < list2.size(); i++) {
                list1.add(2 * i + 1, list2.get(i)); //alternating positions
            }
        } else {
            ...
            for (int i = list1.size(); i < list2.size(); i++) {
                list1.add(list2.get(i)); //rest of elem
            }
        }
